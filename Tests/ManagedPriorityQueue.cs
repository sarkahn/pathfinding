...
namespace Sark.Pathfinding.Tests
{
    ...
    /// </summary>
    /// <typeparam name="T">The values in the queue.  Must extend the Node class</typeparam>
    public sealed class FastPriorityQueue<T>
    {
        ...
        {
            Node node = new Node { Value = value, Priority = priority };
        ...
        public void Resize(int maxNodes)
        {
            ...
            Node[] newArray = new Node[maxNodes + 1];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void UpdatePriority(Node node, int priority)
        {
            node.Priority = priority;
            OnNodeUpdated(node);
        }
