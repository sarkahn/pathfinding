...
public class SpamPathfindingProfiler : MonoBehaviour
{
    TestMapInt _map;
    AStar<int> _astar;
    ...
    private void OnEnable()
    {
        ...
        _astar = new AStar<int>(map.Length, Allocator.Persistent);
        _path = new NativeList<int>(map.Length, Allocator.Persistent);
        _map = map;
        _start = start;
        _end = end;
    }
